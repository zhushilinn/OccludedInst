...
def gather_fig(annotations_copy, images_number):
    ...
    for single in annotations_copy:
        ...
        #print(bbox_need)
        box[image_id-1].append(bbox_need)
    return box

if __name__ == "__main__":
    json_path = "/home/zsl/label_of_city_and_bdd_occlusion/bdd/instances_val2017.json"
    ...
    print(len(images_need_new)) # 5337 761
    with open('/home/zsl/label_of_city_and_bdd_occlusion/bdd/instances_val2017occ.json', 'w') as fp:
